          ...
          <AnimatePresence mode="wait">
            {done ? (
              ...
              >
                ...
                <p className="text-sm text-gray-500 mb-6">Check your email to verify your account.</p>
                <Link to="/signin" className="text-sm text-emerald-600 font-semibold hover:underline">
                  Go to Sign In →
                </Link>
              </motion.div>
            ) : (
              <motion.div key="form">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                  ...
                  {/* Terms */}
                  <motion.p custom={5} variants={fadeUp} initial="hidden" animate="visible" className="text-xs text-gray-400 text-center">
                ...
                {/* Divider
                <motion.div custom={6} variants={fadeUp} initial="hidden" animate="visible" className="flex items-center gap-4 my-5">
                ...
                Social icons
                <motion.div custom={7} variants={fadeUp} initial="hidden" animate="visible" className="flex justify-center gap-5">
                  {[
                    {
                      label: "Google",
                      icon: (
